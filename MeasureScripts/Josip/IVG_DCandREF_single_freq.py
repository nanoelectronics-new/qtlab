...
# Sweeping vector
v_vec = arange(3640.50,4000,0.5)  ##''' !! Take care about step sign '''
...
data = qt.Data(name=' IVG_23-03_G24')  # Put one space before name
...
try:
    for v in v_vec:
        ...
        data.add_data_point(v,result_current, result_mag_f1, result_ph_f1)
