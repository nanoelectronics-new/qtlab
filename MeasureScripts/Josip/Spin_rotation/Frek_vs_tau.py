...
v1_vec = arange(-3e7,3e7,3e6)  #Frequency offset in Hz
f_center = 5.689e9  # Center frequency in Hz
tau_vector_repetitions = 50
...
data.add_coordinate('5.689 GHz + Frequency offset [Hz]')
