...
v1_vec = arange(-150.0e6,150.0e6,1e6)  #Frequency offset in Hz
f_center = 6.631e9  # Center frequency in Hz
...
data.add_coordinate('Frequency_offset (6.631 GHz) [Hz]')
