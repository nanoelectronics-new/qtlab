...
#
        ...
        p.setValuesCH1([0.077, 500.0],[0.023, 0.0],[0.277, 0.0],[0.023,500.0]) 
        p.setMarkersCH1([1,0,0,0],[1,0,0,0])  

        p.setValuesCH2([0.077, 500.0],[0.023, 0.0],[0.277, 0.0],[0.023,500.0]) 
        p.setMarkersCH2([1,0,0,0],[1,0,0,0])

        p.setValuesCH3([0.077, 500.0],[0.023, 500.0],[0.277, 0.0],[0.023,0.0]) 
