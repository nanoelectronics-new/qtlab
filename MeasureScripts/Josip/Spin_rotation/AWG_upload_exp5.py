...
#
        ...
        p.setValuesCH1([0.177, 0.0],[0.023, 500.0],[0.177, 500.0],[0.023,0.0]) 
        p.setMarkersCH1([1,0,0,0],[1,0,0,0])  

        p.setValuesCH2([0.177, 0.0],[0.023, 500.0],[0.177, 500.0],[0.023,0.0]) 
        p.setMarkersCH2([1,0,0,0],[1,0,0,0])

        p.setValuesCH3([0.177, 150.0],[0.023, 150.0],[0.177, 0.0],[0.023,0.0]) 
