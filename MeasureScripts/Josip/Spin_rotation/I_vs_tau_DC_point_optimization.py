...
file_name = '1_3 IV 694'


gain = 1000e6               # Choose between: 1e6 for 1M, 10e6 for 10M, 100e6 for 100M and 1e9 for 1G
tau_vector_repetitions = 15  # Number of whole traces averages
f_center = 5.718e9          # Center frequency in Hz
f_offset = 0.0             # Frequencey offset in MHz
...
taus = arange(0.006,0.160,0.002)    # Should be same like in the used AWG upload script

DAC5_center = -358.31       #  DAC5 center voltage in mV
DAC6_center = -261.14       #  DAC6 center voltage in mV
DAC5_offsets = np.linspace(-0.30,0.30,8) # DAC5 offsets from the center (to be swept through) voltage 
DAC6_offsets = np.array([0.0]) # DAC6 offsets from the center (to be swept through) voltage 
