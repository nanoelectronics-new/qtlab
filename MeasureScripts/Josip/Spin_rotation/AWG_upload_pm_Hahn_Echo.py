...
t_burst = arange(0.006,0.140,0.001)     # Array of increasing durations between the pulses (in the Ramsey experiment case)

delay = 0.013                           # Delay of the IQ in ns
