...
def f_vs_B(vg):
    ...
    file_name = '3_5 IV %d_Vg9=%.2fmV_Vg6=%.2fmV'%(name_counter, vg[0], vg[1])
    ...
    BY_vector = arange(170e-3,130e-3+step_size_BY,step_size_BY) #T  #
    ...
    freq_vec = arange(5.5e9,7.5e9,3e6)  # frequency 
...
V_G9 = [-506.27,-505.65,-505.45,-504.70,-504.60]
V_G6 = [-487.03,-487.17,-486.22,-486.31,-485.60]
