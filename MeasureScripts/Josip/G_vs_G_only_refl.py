...
def do_meas_refl(bias = 200.0, fmw = None, v2_start = 200, v2_stop = 300, v1_start = None, v1_stop = None,v_middle = 0.0):
    ...
    file_name = '7-11 IV %d GvsG_V_middle=%.2fmV_bias=%.2fmV'%(name_counter, v_middle, (bias/100.0))
    ...
    data_mag.add_coordinate('V_G 6 [mV]')       # inner
    ...
    try:
        for i,v1 in enumerate(v1_vec):
            ...
            for j,v2 in enumerate(v2_vec):
                ...
                result_refl = UHFLI_lib.UHF_measure_demod_multiple(Num_of_TC = 2.0, Integration_time = 0.002)  # Reading the lockin
...
do_meas_refl(bias = 0.0, v1_start = -425.0, v1_stop = -390.0, v2_start = -375.5, v2_stop = -345.0, v_middle = -200.0)
