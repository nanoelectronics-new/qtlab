...
do_meas_both(bias = -200.0, v1_start = -535.0, v1_stop = -521.0, v2_start = -503.0, v2_stop = -489.0, static_gate1 = 0.0, static_gate2 = 0.0, v_middle = 3640.0)
do_meas_both(bias = 0.0, v1_start = -535.0, v1_stop = -521.0, v2_start = -503.0, v2_stop = -489.0, static_gate1 = 0.0, static_gate2 = 0.0, v_middle = 3640.0)
