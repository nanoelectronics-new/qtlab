...
# Sweeping vector
v_vec = arange(-2000,2000,100)  #''' !! Take care about step sign '''
...
data = qt.Data(name='IVG_11-08')  # Put one space before name
...
plot2d = qt.Plot2D(data, name='meas_1', autoupdate=False)
