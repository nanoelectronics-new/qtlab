...
By_borders = [[85e-3,115e-3],[115e-3,145e-3],[145e-3,175e-3]]  # Borders or limits of the magnetic field sweep for the scanned F,B windows in T
F_borders = [[4.5e9,5.5e9],[5.5e9,6.5e9],[6.5e9,7.5e9]]  # Borders or limits of the frequency sweep for the scanned F,B windows in Hz
...
try:  
    for By_border in By_borders:
        for F_border in F_borders: 
            ...
            try:
                ...
                print 'Estimated time left: %s hours\n' % str(datetime.timedelta(seconds=int((stop - start)*(len(By_borders)*len(F_borders) - vec_count))))
