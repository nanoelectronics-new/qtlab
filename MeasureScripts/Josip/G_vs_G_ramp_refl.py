...
ramp_amp = 7.0  # Amplitude of the ramp in mV
...
def do_meas_refl(bias = None, v2 = None, v1_start = None, v1_stop = None, v_middle = None, num_aver_pts = 20, num_ramps = 2):
    ...
    v1_vec = arange(v1_start,v1_stop,0.042)      # Outer
...
#
#for Vm in Vms:
do_meas_refl(bias = 0.0, v2 = -530.0, v1_start = -376.0, v1_stop = -360.0, v_middle = 400.0, num_aver_pts = 20, num_ramps = 1)
