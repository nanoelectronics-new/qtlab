...
#
for Vm in Vms:
    do_meas_refl(bias = 0.0, v2 = -430.0, v1_start = -450.0, v1_stop = -350.0, v_middle = Vm, num_aver_pts = 20, num_ramps = 6)
    do_meas_refl(bias = 0.0, v2 = -370.0, v1_start = -450.0, v1_stop = -350.0, v_middle = Vm, num_aver_pts = 20, num_ramps = 6)
    do_meas_refl(bias = 0.0, v2 = -310.0, v1_start = -450.0, v1_stop = -350.0, v_middle = Vm, num_aver_pts = 20, num_ramps = 6)
