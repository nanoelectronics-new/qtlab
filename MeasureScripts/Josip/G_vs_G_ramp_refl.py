...
#for v2 in v2s:
do_meas_refl(bias = 50.0, v2 = -111.5, v1_start = -140.0, v1_stop = -190.0, v_middle = 0.0, num_aver_pts = 40)
do_meas_refl(bias = 50.0, v2 = -111.5, v1_start = -290.0, v1_stop = -330.0, v_middle = 0.0, num_aver_pts = 40)
do_meas_refl(bias = 50.0, v2 = -136.0, v1_start = -325.0, v1_stop = -370.0, v_middle = 0.0, num_aver_pts = 40)
do_meas_refl(bias = 50.0, v2 = -132.0, v1_start = -375.0, v1_stop = -400.0, v_middle = 0.0, num_aver_pts = 40)
