...
#
#for Vm in Vms:
do_meas_refl(bias = 0.0, v2 = -600.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 200.0, num_aver_pts = 20, num_ramps = 10)
do_meas_refl(bias = 0.0, v2 = -500.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 200.0, num_aver_pts = 20, num_ramps = 10)

do_meas_refl(bias = 0.0, v2 = -600.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 400.0, num_aver_pts = 20, num_ramps = 10)
do_meas_refl(bias = 0.0, v2 = -500.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 400.0, num_aver_pts = 20, num_ramps = 10)

do_meas_refl(bias = 0.0, v2 = -600.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 600.0, num_aver_pts = 20, num_ramps = 10)
do_meas_refl(bias = 0.0, v2 = -500.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 600.0, num_aver_pts = 20, num_ramps = 10)

do_meas_refl(bias = 0.0, v2 = -600.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 1000.0, num_aver_pts = 20, num_ramps = 10)
do_meas_refl(bias = 0.0, v2 = -500.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 1000.0, num_aver_pts = 20, num_ramps = 10)

do_meas_refl(bias = 0.0, v2 = -600.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 1400.0, num_aver_pts = 20, num_ramps = 10)
do_meas_refl(bias = 0.0, v2 = -500.0, v1_start = -400.0, v1_stop = -330.0, v_middle = 1400.0, num_aver_pts = 20, num_ramps = 10)
