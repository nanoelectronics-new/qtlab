...
def do_meas():
    ...
    magnetic_field = [0.1,0.2,0.5,1.0,1.5,2.0]  # in T
    ...
    ramp_rate_Y = 0.0004 #T/s
    magnetY.set_rampRate_T_s(ramp_rate_Y)


    
    
    v1_vec = arange(15.5,17.0,0.01)      #outer
    v2_vec = arange(2.5,4.5,0.01)      #inner


    for By in magnetic_field:
    
        file_name = 'G_vs_G_1-3_G2&24_By=%.2fT_'%By
