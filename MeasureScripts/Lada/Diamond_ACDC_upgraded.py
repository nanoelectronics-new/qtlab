...
v1_vec = arange(-400,0,0.3)     #V_g
v2_vec = arange(-500,504,4)  #V_sd 
...
plot3d = qt.Plot3D(data, name='dia8', coorddims=(1,0), valdim=2, style='image') #flipped coordims that it plots correctly
