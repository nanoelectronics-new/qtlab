...
file_name = 'diamond 6-23 f=235,587MHz -35dBm 100Hz'
...
plot3d = qt.Plot3D(data, name='diamond 6-23 2', coorddims=(1,0), valdim=2, style='image') #flipped coordims that it plots correctly
