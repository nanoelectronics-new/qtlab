...
v1_vec = arange(610,630.5,0.5)     #V_g
v2_vec = arange(120,200,1)  #V_sd  
...
data_refl = qt.Data(name=' refl By=2T gvsg 18-13 f=181,6MHz VAR15 -15V -30dBm sensor jumps Vsd=100us') #just renamed

data_dc = qt.Data(name=' DC By=2T gvsg 18-13 Vsd=100us') #added to have current recored as well
...
try:
    for i, v1 in enumerate(v1_vec):
        ...
        for j,v2 in enumerate(v2_vec):
            ...
            new_mat_r[j,i] = result_reflectometry[0] #for saving as matrix
            
            result_dc = dmm.get_readval()/gain*1e12

            new_mat_dc[j,i] = result_dc #for saving as matrix

            data_refl.add_data_point(v2, v1, result_reflectometry[0]) 
