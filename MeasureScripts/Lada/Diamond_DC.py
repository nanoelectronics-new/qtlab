...
file_name = 'diamond dot gate 24-3 5VpV'
...
v1_vec = arange(109,-800,-1)     #V_g
v2_vec = arange(-800,800,20)  #V_sd 
...
plot3d = qt.Plot3D(data, name='dia2', coorddims=(1,0), valdim=2, style='image', palette='bluewhitered') #flipped coordims that it plots correctly
