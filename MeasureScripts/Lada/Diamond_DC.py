...
file_name = 'gate vs gate 17-18 B=1T'
...
v1_vec = arange(26.40,1000,0.2)     #V_g
v2_vec = arange(775,760,-0.2)  #V_sd 
...
plot3d = qt.Plot3D(data, name='gvsg', coorddims=(1,0), valdim=2, style='image') #flipped coordims that it plots correctly
