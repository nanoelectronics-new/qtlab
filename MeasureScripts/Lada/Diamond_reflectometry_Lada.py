...
file_name = '5-24 gate vs gate zoom in'
...
v1_vec = arange(2010,2020,0.2)     #V_g
v2_vec = arange(2380,2360,-0.2)  #V_sd 
...
plot3d = qt.Plot3D(data, name='p3', coorddims=(1,0), valdim=2, style='image') #flipped coordims that it plots correctly
