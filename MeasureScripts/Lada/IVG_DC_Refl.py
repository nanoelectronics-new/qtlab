...
data_refl = qt.Data(name='18-13 reflection 100Hz -30dBm 166,6MHz var15 -10V dot gate, sensor gate=900mV') #just renamed

data_dc = qt.Data(name='18-13 dc dot gate, sensor gate=900mV') #added to have current recored as well
...
for v in v_vec:
    ...
    data_refl.add_data_point(v, result_reflectometry[0]) 
