...
Num_of_waveforms = 200 # Sequence length - correspond to number of rows in slice matrix
Num_of_repetitions = 500
...
qt.mstart()
data = qt.Data(name = "average flagplot 200 waveforms over 500")
data.create_file()
