...
#v_vec = arange(-428,-438.5,-0.06)
v_vec = arange(-400,400,0.06)
...
data = qt.Data(name='Therm_GS_11-15_NOfilter_highres')
...
plot2d = qt.Plot2D(data, name='GS_therm12', autoupdate=False)
