...
bias = 100
v_vec = arange(2762,4000,4)  #''' !! Take care about step sign '''
...
data = qt.Data(name='5-24 sensor gate f=114,7MHz -35dBm')  # Put one space before name
...
plot2d = qt.Plot2D(data, name='lockin2', autoupdate=False, valdim =1)
plot2d.set_style('lines')

plot2d_dmm = qt.Plot2D(data, name='dmm2', autoupdate=False, valdim =2)
