...
v1_vec = arange(-208,-205.99,0.05)   #V_g 1

incl = -1.5  # inclination of sweeping direction

# enter starting point of v2_vec (2 x)
v2_vec = np.linspace(-266.5,-266.5+incl*abs(v1_vec[-1]-v1_vec[0]),len(v1_vec))  #V_g 2
