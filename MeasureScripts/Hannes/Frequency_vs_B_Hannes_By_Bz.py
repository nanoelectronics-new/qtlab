...
step_size_BZ = 2e-3 
step_size_BY = 0.3527e-3 
BZ_vector = arange(380e-3,550e-3+step_size_BZ,step_size_BZ) #T  # Those two vectors need to be the same left
BY_vector = arange(67e-3,180e-3+step_size_BY,step_size_BY) #T  #
...
freq_vec = arange(5.5e9,7e9,1e6)  # frequency 
