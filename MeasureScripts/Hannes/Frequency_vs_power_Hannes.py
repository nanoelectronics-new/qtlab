...
file_name = '1_3 IV 651'

gain = 1000e6 #Choose between: 1e6 for 1M, 10e6 for 10M, 100e6 for 100M and 1e9 for 1G


power_vec = arange(5,-25,-1)
freq_vec = arange(5.645e9,5.715e9,0.025e6)  # frequency 
...
new_mat = np.zeros((len(freq_vec), len(power_vec)),dtype=float16) # Creating empty matrix for storing all data   - ADD THIS LINE FOR MATRIX FILE SAVING, PUT APPROPRIATE VECTOR NAMES
...
data.add_coordinate('Power [dB]')   #v1
...
try:
    for i,power in enumerate(power_vec):  # CHANGE THIS LINE FOR MATRIX FILE SAVING
        ...
        for j,freq in enumerate(freq_vec):  # CHANGE THIS LINE FOR MATRIX FILE SAVING
            ...
            data.add_data_point(freq, power, result)  
