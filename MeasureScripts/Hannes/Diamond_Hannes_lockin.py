...
file_name = '20_22 IV 89'

gain = 100e6 #Choose between: 1e6 for 1M, 10e6 for 10M, 100e6 for 100M and 1e9 for 1G
division_factor = 10e4 # division of lockin signal of S0 (dual ISO in, = 100) and S3b cards
...
v1_vec = arange(-215,-265.5,-0.5)   #V_g
v2_vec = arange(-600,602,2)  #V_sd 
...
try:
    for i,v1 in enumerate(v1_vec):  # CHANGE THIS LINE FOR MATRIX FILE SAVING
        ...
        for j,v2 in enumerate(v2_vec):  # CHANGE THIS LINE FOR MATRIX FILE SAVING
            ...
            # readout
            result_lockin = dmm_lockin.get_readval()/(gain*division_factor)*1e12  # Reading the lockin and correcting for M1b gain
