...
class AMI430_Bz(Instrument):
    ...
    COILCONSTANT = 0.1106       #T/A              #0.0510 for Bx            #0.09279 for the center fridge
    ...
    CURRENTRAMPLIMIT = 0.066     #A/s    0.0025 for Bx
    ...
    def __init__(self, name, address='10.21.64.128', port=7180):
