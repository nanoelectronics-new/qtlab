...
class AMI430_By(Instrument):
    ...
    COILCONSTANT = 0.0413       #T/A              #0.09279 for the center fridge
    ...
    def __init__(self, name, address='10.21.64.144', port=7180):
